...
class CreateBackup extends Tool
{
    ...
    public function handle(array $arguments): ToolResult
    {
        ...
        if (!empty($arguments['name'])) $data['name'] = $arguments['name'];
        if (!empty($arguments['web_application_id'])) $data['webApplicationId'] = $arguments['web_application_id'];
        if (!empty($arguments['database_id'])) $data['databaseId'] = $arguments['database_id'];
        if (!empty($arguments['backup_type'])) $data['backupType'] = $arguments['backup_type'];
        if (!empty($arguments['storage'])) $data['storage'] = $arguments['storage'];
        if (!empty($arguments['format'])) $data['format'] = $arguments['format'];
        if (!empty($arguments['frequency'])) $data['frequency'] = $arguments['frequency'];
        if (!empty($arguments['retention'])) $data['retention'] = $arguments['retention'];
        if (isset($arguments['exclude_development_files'])) $data['excludeDevelopmentFiles'] = $arguments['exclude_development_files'];
        if (isset($arguments['exclude_wordpress_cache_files'])) $data['excludeWordpressCacheFiles'] = $arguments['exclude_wordpress_cache_files'];
        if (isset($arguments['success_notification'])) $data['successNotification'] = $arguments['success_notification'];
        if (isset($arguments['fail_notification'])) $data['failNotification'] = $arguments['fail_notification'];
